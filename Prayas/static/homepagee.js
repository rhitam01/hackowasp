          ...
          function _(q, j) {
            ...
            return (
              ...
              (h.open = function (ae) {
                if (
                  ((z = {}),
                  u(ae) ? (z = ae.call(h, be, ne, h, q)) : o(ae) && (z = ae),
                  o(z))
                )
      ...
      var G = (c.frame = (function () {
        ...
        ye = H(function (e) {
          function r(L, $) {
            ...
            if (!$.weak || !this.props[V]) {
              var me = ce[0],
                de = this.props[V];
              return (
                de || (de = this.props[V] = new me.Bare()),
                de.init(this.$el, ee, ce, $),
                de
              );
            }
          }
          ...
          function _(L) {
            ...
            typeof L == "string"
              ? (($ = {}), ($[L] = 1))
              : ($ = typeof L == "object" && L != null ? L : this.props),
              be.call(this, $, ae),
              ne.call(this);
          }
          function q(L) {
          ...
          function ne() {
            ...
            for (L in this.props)
              ($ = this.props[L]), $.active && ee.push($.string);
            (ee = ee.join(",")),
              this.style !== ee &&
        ...
        R = H(function (e) {
          ...
          function o(s) {
            ...
            return (_ ? M(_[1], _[2], _[3]) : s).replace(
              /#(\w)(\w)(\w)$/,
              "#$1$1$2$2$3$3"
            );
          }
                ...
                i.call(this, o, function (_, q, j) {
                  (s[_] = q),
                    this.current[_] === void 0 &&
                      ((u = 0),
                      ~_.indexOf("scale") && (u = 1),
                      (this.current[_] = this.convert(u, j)));
                }),
                s
              );
            });
        ...
        Ce = H(function (e) {
          ...
          (e.init = function (h) {
            ...
            z === void 0 && (z = _.from),
              ne === void 0 && (ne = _.to),
              (this.unit = h.unit || ""),
              typeof z == "number" && typeof ne == "number"
                ? ((this.begin = z), (this.change = ne - z))
                : this.format(ne, z),
            ...
            (e.destroy = function () {
              this.stop(),
                (this.context = null),
                (this.ease = this.update = this.complete = d);
            });
          var q = [],
            j = 1e3;
        }),
          ...
          (e.init = function (i) {
            ...
            (e.render = function (i) {
              ...
              for (o = s; o--; )
                (u = this.tweens[o]),
                  u.context &&
                    (u.render(i), (this.current[u.name] = u.value), (_ = !0));
              return _
        ...
        (t.debounce = function (a, l, y) {
          var w,
            ...
            ye = function () {
              var ie = t.now() - G;
              ie < l
                ? (w = setTimeout(ye, l - ie))
                : ((w = null), y || ((le = a.apply(S, I)), (S = I = null)));
            };
          return function () {
      ...
      return (
        (t.template = function (a, l, y) {
          ...
          var w = RegExp(
              [
                (l.escape || ue).source,
                (l.interpolate || ue).source,
                (l.evaluate || ue).source,
              ].join("|") + "|$",
              "g"
            ),
            I = 0,
        ...
        function p(g, a) {
          ...
          switch (a) {
            case "add":
              (l = g.attr("tabindex")),
                l
                  ? g.attr("data-wf-tabindex-swap", l)
                  : g.attr("tabindex", "-1");
              break;
            case "remove":
              (l = g.attr("data-wf-tabindex-swap")),
                l
                  ? (g.attr("tabindex", l),
        ...
        function D(g, a) {
          ...
          if (l !== y) {
            var w = ue(g, l, y),
              ...
              S = function () {
                var G = Date.now() - I;
                window.scroll(0, he(l, y, G, w)),
                  G <= w ? x(S) : typeof a == "function" && a();
              };
            x(S);
          }
        }
    ...
    Gt.define(
      ...
      (dt.exports = function (t) {
        ...
        (t.event.special.tap = { bindType: "click", delegateType: "click" }),
          (c.init = function (d) {
            return (
              (d = typeof d == "string" ? t(d).get(0) : d), d ? new k(d) : null
            );
          });
        function k(d) {
          var A = !1,
          ...
          function H(N) {
            ...
            (F && F.length > 1) ||
              ((A = !0),
              F ? ((x = !0), (B = F[0].clientX)) : (B = N.clientX),
              (Z = B));
          }
          function X(N) {
            if (A) {
              ...
              (Z = C),
                Math.abs(p) > W &&
                  f &&
                  String(f()) === "" &&
                  (M("swipe", N, { direction: p > 0 ? "right" : "left" }), K());
            }
          }
          function T(N) {
  ...
  var pt = fe((fn, vt) => {
    ...
    Qe.define(
      ...
      (vt.exports = function (t, c, f) {
        if (
          ((f = f || {}),
          (Qe.env("test") || Qe.env("frame")) && !f.fixture && !Zt())
        )
          return { exit: 1 };
        var k = {},
          M = t(window),
        ...
        function K(O, E) {
          t.ajax({ type: "GET", url: O, dataType: "script", cache: !0 }).then(
            E,
            U
          );
        }
        ...
        function N(O) {
          return O.indexOf("//") >= 0
            ? O
            : F("https://editor-api.webflow.com" + O);
        }
        function F(O) {
        ...
        function t(f) {
          ...
          function W(p) {
            var O = p.type,
              E = p.tagName;
            return !!(
              (E === "INPUT" && A[O] && !p.readOnly) ||
              (E === "TEXTAREA" && !p.readOnly) ||
              p.isContentEditable
            );
          }
          function B(p) {
          ...
          function H(p) {
            p.metaKey ||
              p.altKey ||
              p.ctrlKey ||
              (x(f.activeElement) && B(f.activeElement), (k = !0));
          }
          function X() {
            k = !1;
          }
  ...
  var yt = fe((dn, gt) => {
    ...
    Pe.define(
      ...
      (gt.exports = function (t, c) {
        ...
        function K(F) {
          var C =
            (M && F.getAttribute("href-disabled")) || F.getAttribute("href");
          if (((x.href = C), !(C.indexOf(":") >= 0))) {
            var p = t(F);
            if (
              x.hash.length > 1 &&
              x.host + x.pathname === A.host + A.pathname
            ) {
      ...
      (Et.exports = function () {
        ...
        function k(A) {
          ...
          return (
            ...
            (/^input$/i.test(W) &&
              /^(button|reset|submit|radio|checkbox)$/i.test(x.type) &&
              !x.disabled) ||
            (!/^(button|input|textarea|select|a)$/i.test(W) &&
              !Number.isNaN(Number.parseFloat(x.tabIndex))) ||
            /^audio$/i.test(W) ||
    ...
    jt.define(
      ...
      (_t.exports = function () {
        function t(d) {
          for (
            var A = [d], x = null;
            (x = d.parentNode || d.host || d.defaultView);
        ...
        function c(d) {
          typeof d.getAttribute != "function" ||
            d.getAttribute("data-wf-focus-within") ||
            d.setAttribute("data-wf-focus-within", "true");
        }
        function f(d) {
          typeof d.getAttribute != "function" ||
            !d.getAttribute("data-wf-focus-within") ||
            d.removeAttribute("data-wf-focus-within");
        }
        function k() {
          var d = function (A) {
            var x;
            function W() {
              (x = !1),
                A.type === "blur" &&
                  Array.prototype.slice.call(t(A.target)).forEach(f),
                A.type === "focus" &&
                  Array.prototype.slice.call(t(A.target)).forEach(c);
            }
    ...
    Lt.define(
      ...
      (At.exports = function (t) {
        ...
        c.ready = function () {
          ...
          /\.webflow\.io$/i.test(K) && A.hostname !== K && (T = !0),
            T &&
              !x &&
              ((B = B || H()),
              X(),
        ...
        function H() {
          var T = t('<a class="w-webflow-badge"></a>').attr(
              "href",
  ...
  var St = fe((mn, Ct) => {
    ...
    var je = window.jQuery,
      ...
      Xe = {
        ...
        intro: function (t, c) {
          c.__wf_intro ||
            ((c.__wf_intro = !0), je(c).triggerHandler(_e.types.INTRO));
        },
        outro: function (t, c) {
          c.__wf_intro &&
            ((c.__wf_intro = null), je(c).triggerHandler(_e.types.OUTRO));
        },
      };
    _e.triggers = {};
      ...
      (Pt.exports = function (t, c) {
        ...
        function he(n, v) {
          ...
          J &&
            ...
            a(m),
            B
              ? (ve(m), m.el.on("setting" + T, l(m)))
              : (g(m),
                m.button.on("click" + T, G(m)),
                m.menu.on("click" + T, "a", le(m)),
                m.button.on("keydown" + T, y(m)),
                m.el.on("keydown" + T, w(m))),
            R(n, v);
        }
        function Oe(n, v) {
          var b = t.data(v, T);
        ...
        function a(n) {
          ...
          (v.duration = J != null ? Number(J) : 400),
            (v.docHeight = n.el.attr("data-doc-height")),
            (n.config = v);
        }
        function l(n) {
          return function (v, b) {
        ...
        function ke(n, v) {
          ...
          if (
            (n.overlay &&
              ((O = n.menu.prev()), n.overlay.show().append(n.menu)),
            b.animOver)
          ) {
            k(n.menu)
              .add(i)
          ...
          function r() {
            n.menu.height(""),
              ...
              n.overlay &&
                ...
                (O.length ? n.menu.insertAfter(O) : n.menu.prependTo(n.parent),
